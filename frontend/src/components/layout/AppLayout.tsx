  ...
  return (
    <div className="relative flex h-dvh w-full flex-col overflow-hidden bg-gradient-to-br from-white via-orange-50/60 to-orange-100/40 p-2 sm:p-4 md:flex-row md:gap-4">
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-20 left-1/3 h-96 w-96 rounded-full bg-orange-300/50 blur-3xl" />
        <div className="absolute bottom-0 right-10 h-80 w-80 rounded-full bg-amber-200/50 blur-3xl" />
        <div className="absolute right-1/3 top-1/3 h-72 w-72 rounded-full bg-rose-200/40 blur-3xl" />
      </div>
      <Sidebar />
